...
<body>
    ...
    <nav class="navbar navbar-expand-lg ">
        <div class="container-fluid">
            <a class="navbar-brand ms-3" href="../index.html">
                <img src="../assets/Image/evidyalogo.jpg" alt="pre-logo" class="img-fluid logo1" width="55px"
                    height="50px">
                <img src="../assets/Image/evidyaban_1000x250.png" alt="logoImg" class="img-fluid logo2" width="275px"
                    height="75px">
            </a>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5 mx-3">
            <div class="col-lg-6">
                <h2 class="head-color donate-1st-head">"Support 1 child"</h2>
                <h1 class="nav-link-color donate-us-2nd-head"> INR 1,000</h1>
                <div class=" d-flex mt-3 me-3 justify-content-end  align-items-baseline">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        <div class="">
                            <input type="number" name="1child" id="1child" placeholder="&#8377 1,000"
                                class="shadow px-5 py-3 border-0 donate-input">
                        </div>
            ...
            <div class="col-lg-6">
                <div>
                    <img src="../assets/Image/donate1.png" alt="donate-img" class="img-fluid">
                </div>
            </div>
        </div>
        <div class="row mt-5 mx-3">
            <div class="col-lg-6">
                <div>
                    <img src="../assets/Image/donate2.png" alt="donate-img" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-6 ">
                <h2 class="head-color ms-4 donate-1st-head">"Support 3 child"</h2>
                <h1 class="nav-link-color ms-4 donate-us-2nd-head"> INR 3,000</h1>
                <div class=" d-flex mt-3 justify-content-end   align-items-baseline">
                    <div class="text-right me-3 genral-contribution-css">
                        <p class=" mb-0">Genral</p>
                        <p> Contribution</p>
                    </div>
                    <div class="d-flex flex-column align-items-end">
                        <div class="">
                            <input type="number" name="1child" id="1child" placeholder="&#8377 3,000"
                                class="shadow px-5 py-3 border-0 donate-input">
                        </div>
                        <div class="btn btn-primary donate-btn-clr donate-btn-clr-1 mt-3 p-3">Donate Now</div>
                    </div>
        ...
        <div class="row mt-5 mx-3">
            <div class="col-lg-6">
                <h2 class="head-color donate-1st-head">"Support 5 child"</h2>
                ...
                <div class=" d-flex mt-3  me-3 justify-content-end  align-items-baseline">
                    ...
                    <div class="d-flex flex-column align-items-end">
                        <div class="">
                            <input type="number" name="1child" id="1child" placeholder="&#8377 5,000"
                                class="shadow px-5 py-3 border-0 donate-input">
                        </div>
                        <div class="btn btn-primary donate-btn-clr donate-btn-clr-1 mt-3 p-3">Donate Now</div>
                    </div>
            ...
            <div class="col-lg-6">
                <div>
                    <img src="../assets/Image/donate3.png" alt="donate-img" class="img-fluid">
                </div>
            </div>
        </div>
        <div class="row bg-color-genral my-5" style="margin-right: 0;">
            <div>
                <h3 class="nav-link-color mt-5"> Program Impact </h3>
        ...
        <div class="row" style="margin-right: 0; margin-left:0 ;">
            <div class="col-12">
                <h3 class="nav-link-color mt-5"> Together, we can ensure Rural India continues to learn </h3>
                <p class="mt-3">
              ...
              session_destroy();
                ...
                <form method="post" name="emailform" action="email.php">
                    <div class="form-group mt-3">
                        <input type="Name" name="fullname" class="form-control pb-5" id="Name" placeholder="Name"
                            required>
                    </div>
                    <div class="form-group mt-3">
                        <input type=" number" name="ph_number" class="form-control pb-5" id="Number"
                            placeholder="Phone Number" required>
                    </div>
                    <div class="form-group mt-3">
                        <input type=" email" name="email" class="form-control pb-5" id="Email"
                            aria-describedby="emailHelp" placeholder="Email ID" required>
                    </div>
                    <textarea class="form-control text-area mt-3" name="message" id=" Textarea"
                        placeholder="Input Field" rows="3" required></textarea>
                    <button type="submit" class="btn btn-primary mt-3 float-end donate-btn-clr w-25">Register</button>
                </form>
            </div>
            <div class="col-lg-6">
                <div>
                    <img src="../assets/Image/donate-charity.png" alt="charity-img" class="img-fluid charity-img">
                </div>
            </div>
        </div>
            
        <div class="row bg-color-genral mt-5">
                        ...
                        <div class="container">
                            <div class="d-flex align-items-center d-flex-responsive ">
                                <div class="d-flex flex-column align-items-center p-3">
                                    <div class="test-img">
                                        <img src="../assets/Image/testimonial1.jpg" alt="test-img"
                                            class="img-fluid mx-auto d-block br-50">
                                    </div>
                                ...
                                <div class="d-flex flex-column align-items-center p-3">
                                    <div class="test-img">
                                        <img src="../assets/Image/testimonial1.jpg" alt="test-img"
                                            class="img-fluid  br-50 mx-auto d-block">
                                    </div>
                                    <div class=" text-center">
                                        <p class="mt-1 mb-0">Madhukar B.K</p>
                                        <p class="mb-0">Individual Donor, Bangalore</p>
        ...
        <div class="row col-md-10 mt-5">
            <div class="ms-5">
                <h3 class="nav-link-color "> Key info :</h3>
                <ul class="style-type-none p-0">
                    <li class="mt-5"> Donations made to eVidyaloka Trust are exempt from tax under Section 80G of
                        the
                        Income Tax Act.</li>
        ...
        <div class="row bg-color-genral">
            <div class="col-12 ">
                <h2 class="nav-link-color ms-3 mt-3">Enable the transformation!</h2>
            </div>
            <div class="col-5">
                <div class="d-flex justify-content-end">
                    <div class="text-right me-3 mt-5 genral-contribution-css">
                        <p class=" mb-0">Genral</p>
                        <p> Contribution</p>
                    </div>
                </div>
            ...
            <div class="col-7">
                <div class="d-flex flex-column">
                    <ul class="nav nav-pills " id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item border-li" role="presentation">
                            <button class="nav-link border-btn" id="pills-profile-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile"
                                aria-selected="false"> <span>&#8377</span>
                                3,000</button>
                        </li>
                        <li class="nav-item border-li" role="presentation">
                            <button class="nav-link border-btn" id="pills-contact-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact"
                                aria-selected="false"><span>&#8377</span>
                                5,000</button>
                        </li>
                    </ul>
                    <div class="d-flex flex-row justify-content-between align-items-center border-content shadow">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                aria-labelledby="pills-home-tab">
                                <input type="number" name="number" value="1000">
                                <div class=" me-3  genral-contribution-css">
            ...
            <div class="footer my-3">
                <p class=" ms-3 my-3">© eVidyaloka Trust 2016 |Terms of Service Privacy</p>
            </div>
        </div>
